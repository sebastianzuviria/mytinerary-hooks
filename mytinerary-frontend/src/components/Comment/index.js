      ...
      <div className='CommentBox'>
        <div className='Comment'>
          <div className='CommentHeader'>
            ...
            {user && user.id === commentUser.id && <div className='Delete' onClick={deleteComment}><i className='fas fa-trash' /></div>}
          </div>
        ...
        <div className='ButtonBox' style={styles.buttonBox}>
          <div className='Likes'>
            {numberLikes}
            {user
              ? <div onClick={likedComment}>{buttonLike === 'like' ? <i className='far fa-thumbs-up Like' /> : <i className='fas fa-thumbs-up Liked' />}</div>
              : <div disabled><i className='far fa-thumbs-up' /></div>}
          </div>
          <div className='Dislikes'>
            {numberDislikes}
            {user
              ? <div onClick={dislikedComment}>{buttonDislike === 'dislike' ? <i className='far fa-thumbs-down Dislike' /> : <i className='fas fa-thumbs-down Disliked' />}</div>
              : <div disabled><i className='far fa-thumbs-down' /></div>}
          </div>
        </div>
      </div>
    </div>
